...
{
    public NodeViewModel(Ga144NodeConfiguration model, KrakenNodeRoute? krakenRoute = null)
    {
        Model = model;
    ...
    public Visibility KrakenVisibility => KrakenRoute is null ? Visibility.Collapsed : Visibility.Visible;
    public string KrakenLabel => KrakenRoute switch
    {
        { IsHead: true } => "K HEAD",
    ...
    public Brush KrakenBrush => KrakenRoute?.TentacleNumber switch
    {
        1 => Brushes.SteelBlue,
